...
st.set_page_config(page_title="AI Resume Reader", page_icon="📄", layout="centered")
...
job_role = st.text_input("Enter the job title you are applying for")
